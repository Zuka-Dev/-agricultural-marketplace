...
async function getDashboardStats() {
  try {
    const [usersResult, productsResult, ordersResult] = await Promise.all([
      ...
      pool.query("SELECT COUNT(*), SUM(total_amount) FROM orders WHERE status = $1", ["completed"]),
    ])
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="card p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-soil-600 text-sm font-medium">Total Customers</p>
              <p className="text-3xl font-bold text-soil-800">{stats.totalCustomers}</p>
            </div>
        ...
        <div className="card p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-soil-600 text-sm font-medium">Total Products</p>
              <p className="text-3xl font-bold text-soil-800">{stats.totalProducts}</p>
            </div>
        ...
        <div className="card p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-soil-800">{stats.totalOrders}</p>
            </div>
        ...
        <div className="card p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-soil-800">₦{stats.totalRevenue.toLocaleString()}</p>
            </div>
            <div className="bg-forest-100 p-3 rounded-full">
